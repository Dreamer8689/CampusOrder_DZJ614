...
public class PopupDishAdapter extends RecyclerView.Adapter{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cart_dish_item, parent, false);
    ...
    private class DishViewHolder extends RecyclerView.ViewHolder{
       ...
       private LinearLayout right_dish_layout;
        ...
        public DishViewHolder(View itemView) {
            super(itemView);
            right_dish_name_tv = (TextView)itemView.findViewById(R.id.cart_dish_name);
            right_dish_price_tv = (TextView)itemView.findViewById(R.id.cart_dish_price);
            right_dish_layout = (LinearLayout)itemView.findViewById(R.id.cart_dish_item);
            right_dish_remove_iv = (ImageView)itemView.findViewById(R.id.cart_dish_remove);
            right_dish_add_iv = (ImageView)itemView.findViewById(R.id.cart_dish_add);
            right_dish_account_tv = (TextView) itemView.findViewById(R.id.cart_dish_account);
        }
